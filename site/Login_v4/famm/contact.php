...
<fieldset>
<input type="text" placeholder="Enter your full name" name="nom" required />
                           <input type="text" placeholder="Enter your full name" name="prenom" required />
                           <input type="email" placeholder="Enter your email address" name="email" required />
                           <input type="text" placeholder="Enter your mobile nuber" name="tele" required />
